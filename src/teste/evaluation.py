...
def generate_signals(input_df, start_capital=100000, share_count=2000,buy_signal='Buy Signal'):
...
# Set initial capital:
    ...
    signals_df['Position'] = share_size * np.max(signals_df[buy_signal],0)

    # Make Entry / Exit Column:
    signals_df['Entry/Exit']=signals_df[buy_signal].diff()
